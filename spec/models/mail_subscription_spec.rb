...
describe MailSubscription do
  specify 'destroy archives' do
    ms = MailSubscription.create!(gender: 'male', interval: 'weekly', categories: [1], extended_member: true, email: 'info@example.com', confirmed: true, first_name: 'John', last_name: 'M', company: 'FOOBAR', limit: 50)
